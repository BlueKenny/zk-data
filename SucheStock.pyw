...
def tbFunc(btn):
	...
	if btn == "NEU":
		...
		if appChange.getEntry("Barcode") == "" or appChange.getEntry("Barcode") == "x": appChange.setEntry("Barcode", "12345678" + IDToChange)
	...
	if btn == "ÄNDERN":
		...
		if not "P" in IDToChange:
			...
			appChange.setEntry("Barcode", "12345678" + IDToChange)
